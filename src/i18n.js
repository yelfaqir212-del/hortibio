...
const fr = {
  nav: {
    ...
    hortibioCatalog: "Catalogue Horti Bio",
    flow:    "Pourquoi nous",
    ceo:     "Notre vision",
    contact: "Contact",
...
const en = {
  nav: {
    ...
    hortibioCatalog: 'Horti Bio Catalog',
    flow:    'Why us',
    ceo:     'Our vision',
    contact: 'Contact',
    openMenu: 'Open menu',
  ...
  hortibioCatalog: {
    eyebrow: 'Products Catalog',
    title: 'Products Catalog',
    lead: 'Browse the official Horti Bio catalog directly on the website with an animated page-by-page reader.',
    readerLabel: 'Products Catalog',
    pageStatus: 'Page {{page}} / {{total}}',
